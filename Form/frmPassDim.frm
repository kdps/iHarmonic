...
Begin VB.Form frmPassDim 
   ...
   Begin MSComctlLib.ImageList ImageList 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPassDim.frx":1272
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPassDim.frx":180C
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPassDim.frx":1DA6
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmPassDim.frx":2340
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cbInv 
         ...
         EndProperty
         Height          =   315
         ItemData        =   "frmPassDim.frx":28DA
         Left            =   120
         List            =   "frmPassDim.frx":28EA
         TabIndex        =   4
         Top             =   2880
         Width           =   5655
      End
...
lstDiatonic.ListItems.Add , , NotetoText(Key - 1) & "Dim7", , 1
lstDiatonic.ListItems(1).ListSubItems.Add 1, , Key - 1 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key) & "M7", , 2
lstDiatonic.ListItems(2).ListSubItems.Add 1, , Key & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 1) & "Dim7", , 1
lstDiatonic.ListItems(3).ListSubItems.Add 1, , Key + 1 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 2) & "m7", , 3
lstDiatonic.ListItems(4).ListSubItems.Add 1, , Key + 2 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 3) & "Dim7", , 1
lstDiatonic.ListItems(5).ListSubItems.Add 1, , Key + 3 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 4) & "m7", , 2
lstDiatonic.ListItems(6).ListSubItems.Add 1, , Key + 4 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 4) & "Dim7", , 1
lstDiatonic.ListItems(7).ListSubItems.Add 1, , Key + 4 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 5) & "M7", , 3
lstDiatonic.ListItems(8).ListSubItems.Add 1, , Key + 5 & "/" & "M7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 6) & "Dim7", , 1
lstDiatonic.ListItems(9).ListSubItems.Add 1, , Key + 6 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 7) & "7", , 4
lstDiatonic.ListItems(10).ListSubItems.Add 1, , Key + 7 & "/" & "M7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 8) & "Dim7", , 1
lstDiatonic.ListItems(11).ListSubItems.Add 1, , Key + 8 & "/" & "Dim7" & "/" & "0"

lstDiatonic.ListItems.Add , , NotetoText(Key + 9) & "m7", , 2
lstDiatonic.ListItems(12).ListSubItems.Add 1, , Key + 9 & "/" & "m7" & "/" & "0"
End Sub
