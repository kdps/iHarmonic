...
Function ComputerName() As String
    ...
    strComName = String(255, Chr(0))
    GetComputerName strComName, 255
    strComName = Left(strComName, InStr(1, strComName, Chr(0)))

    ComputerName = strComName
End Function

Function KeyGen(kNamev As Variant, kPass As String, kType As Integer) As String
'****************************************************************************
'* KeyGen v2.01 Build 02                                                    *
'* Copyright ?2000, William Gerard Griffiths. All Rights Reserved.         *
'*                                                                          *
'* Url: http://www.llanelly.com                                             *
'* E-Mail: w.g.griffiths@llanelly                                           *
'*                                                                          *
